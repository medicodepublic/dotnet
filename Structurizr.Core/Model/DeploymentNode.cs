...
namespace Structurizr
{
    ...
    public sealed class DeploymentNode : DeploymentElement
    {
        ...
        public int Instances
        {
            ...
            set
            {
                if (value < 1) throw new ArgumentException("Number of instances must be a positive integer.");
        ...
        {
            get => new HashSet<DeploymentNode>(_children);

            internal set => _children = new HashSet<DeploymentNode>(value);
        }
        ...
        {
            get => new HashSet<InfrastructureNode>(_infrastructureNodes);

            internal set => _infrastructureNodes = new HashSet<InfrastructureNode>(value);
        }
        ...
        {
            get => new HashSet<ContainerInstance>(_containerInstances);

            internal set => _containerInstances = new HashSet<ContainerInstance>(value);
        }
        ...
        public override string CanonicalName
        {
            get
            {
                ...
                return CanonicalNameSeparator + "Deployment" + CanonicalNameSeparator +
                       FormatForCanonicalName(Environment) + CanonicalNameSeparator + FormatForCanonicalName(Name);
            }
        }
        ...
        public ContainerInstance Add(Container container)
        {
            ...
            var containerInstance = Model.AddContainerInstance(this, container);
        ...
        {
            var deploymentNode =
                Model.AddDeploymentNode(this, Environment, name, description, technology, instances, properties);
            if (deploymentNode != null) _children.Add(deploymentNode);
        ...
        {
            if (string.IsNullOrEmpty(name)) throw new ArgumentException("A name must be specified.");
        ...
        public InfrastructureNode AddInfrastructureNode(string name, string description, string technology,
            Dictionary<string, string> properties)
        {
            var infrastructureNode = Model.AddInfrastructureNode(this, name, description, technology, properties);
            if (infrastructureNode != null) _infrastructureNodes.Add(infrastructureNode);
