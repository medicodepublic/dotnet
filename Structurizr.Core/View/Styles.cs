...
namespace Structurizr
{
    ...
    public sealed class Styles
    {
        ...
        {
            get => new List<RelationshipStyle>(_relationships);

            internal set => _relationships = new List<RelationshipStyle>(value);
        }
        ...
        {
            get => new List<ElementStyle>(_elements);

            set => _elements = new List<ElementStyle>(value);
        }
        ...
        public void Add(ElementStyle elementStyle)
        {
            if (elementStyle != null)
            {
                if (_elements.Exists(es => es.Tag.Equals(elementStyle.Tag)))
                    throw new ArgumentException("An element style for the tag \"" + elementStyle.Tag +
                                                "\" already exists.");
        ...
        public void Add(RelationshipStyle relationshipStyle)
        {
            if (relationshipStyle != null)
            {
                if (_relationships.Exists(es => es.Tag.Equals(relationshipStyle.Tag)))
                    throw new ArgumentException("A relationship style for the tag \"" + relationshipStyle.Tag +
                                                "\" already exists.");
