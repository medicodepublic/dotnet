...
namespace Structurizr
{
    ...
    public abstract class ModelItemView
    {
        ...
        {
            if (string.IsNullOrEmpty(name)) throw new ArgumentException("A property name must be specified.");

            if (string.IsNullOrEmpty(value)) throw new ArgumentException("A property value must be specified.");
